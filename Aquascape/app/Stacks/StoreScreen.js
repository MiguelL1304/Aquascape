...
const StoreScreen = ({ navigation }) => {
  const items = [
    ...
    { id: '4', name: 'Blue Tang', image: require("../../assets/bluetang.gif"), price: '100' },
    { id: '5', name: 'Cat Fish',image: require("../../assets/catfish.gif"), price: '100' },
    { id: '6', name: 'Goldfish',image: require("../../assets/goldfish.gif"), price: '100' },
